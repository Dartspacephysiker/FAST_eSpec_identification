;2016/08/16 Trying to get a sense of what we've got here.
...
PRO JOURNAL__20160816__CAREFULLY_CHECK_COORD_CONVERSION__NAME_ANY_OLD_ORBIT
  ...
  orbStringArr        = STRCOMPRESS(orbNumArr,/REMOVE_ALL)

  ;;Want to convert and save coordinates?
  do_conversions      = 0
  convert_if_no_exist = 1
  ...
  littleBabyFilePref  = '/SPENCEdata/Research/Satellites/FAST/espec_identification/saves_output_etc/eSpecTest_orb' 
  ;; 


  orig_routineName    = 'JOURNAL__20160816__CAREFULLY_CHECK_COORD_CONVERSION__FOR_EXAMPLE_ORB_1000_AND_5000'
  ...
  FOR k=0,N_ELEMENTS(orbNumArr)-1 DO BEGIN
     ...
     IF KEYWORD_SET(convertMePlease) THEN BEGIN
        ...
        PRINT,'Saving eSpecEphem, eSpec_GEO, eSpec_GEI, eSpec_MAG, and eSpec_AACGM_v2 for orbit ' + orbString + ' ...'
